function Navbar() {
    return (
        <>
            <div id="navbar_container" className="sp_bew">
                <div className="flex sp_bew" style={{width: '25%'}}>
                    <div>
                        <a href="#">
                    ...
                    <div>
                        <div>Delivery in 17 minutes</div>
                        <div>Ahmedabad, Gujarat 380007, India</div>
                    </div>
                </div>
                <div style={{width: '40%'}} className="search_product">
                    <input type="text" style={{width: '100%'}} />
                </div>
                <div id="" className="flex sp_bew" style={{width: '20%'}}>
                    <div id="profile_button_container">
                        <div>Login</div>
                    </div>
                    <div id="cart_button_container">
                        <div></div>
                        <div>My Cart</div>
                    </div>
                </div>
